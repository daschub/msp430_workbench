...
void splitString(uint8_t *transmittedString);
...
void validateCalender(void)
{
    ...
    if (command_checkString){
        splitString(receivedString);                                    // funktion, die die jeweiligen datumsparamter in die struktur schreibt
 ...
 */
void splitString(uint8_t *receivedString)
{
    uint8_t delimiter[] = ".,:";
    uint8_t *ptr;
